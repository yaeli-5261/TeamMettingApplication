...
import { Box, Paper, Avatar, Typography, CircularProgress, Alert, TextField } from "@mui/material";
      ...
      >
        <Box sx={{ maxWidth: "800px", mx: "auto", p: 2 }}>
          {loading ? (
            ...
            <Alert severity="error" sx={{ borderRadius: "8px", bgcolor: "#fef7f0" }}>
              {error}
            </Alert>
          ) : (
